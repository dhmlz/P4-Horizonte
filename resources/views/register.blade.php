...
<head>
    ...
    <title>Raio Horizonte - Registro</title>
    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block bg-register-image text-center p-5"><h1 class="h4 text-gray-900 mb-4">SISTEMA DE P4 </br>
